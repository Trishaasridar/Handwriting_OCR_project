...
class Config:
    ...
    MAX_CONTENT_LENGTH = 500 * 1024 * 1024   # 500 MB total per request
    MAX_FILE_SIZE     = 20  * 1024 * 1024    # 20 MB per individual file
    MAX_FILES_PER_BATCH = 50                  # max images in one upload
    ...
    MAX_PROCESSING_TIME = int(os.environ.get('MAX_PROCESSING_TIME', 900))  # 15 min for large batches
    ...
    # API metadata
    API_TITLE = 'Handwriting OCR API v4'
    API_VERSION = '4.0.0'
